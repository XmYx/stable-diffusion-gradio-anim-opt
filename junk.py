...
anim = gr.Interface(
    ...
    inputs=[
        ...
        gr.Textbox(label='Noise Schedule',  placeholder="0:(0)", lines=1, value="0:(0)"),
        gr.Textbox(label='Strength_Schedule',  placeholder="0:(0)", lines=1, value="0:(0)"),
        gr.Textbox(label='Contrast Schedule',  placeholder="0:(0)", lines=1, value="0:(0)"),
